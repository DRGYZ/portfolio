...
const moodRows: MoodRowData[] = [
  {
    id: 'coding',
    name: 'Coding / Review',
    category: 'Engineering Mode',
    triggerCondition: 'Active IDE foregrounded (VS Code, Visual Studio, terminal) + low ambient audio.',
  ...
  },
  {
    ...
    triggerCondition: 'Continuous background audio session detected (Spotify, music streams) with active peak volume.',
  ...
  },
  {
    ...
    triggerCondition: 'Web browser active with technical docs, research articles, or frequent tab exploration.',
  ...
  },
  {
    id: 'sleepy',
    name: 'Sleepy / Idle',
    category: 'Standby Resting',
    triggerCondition: 'Inactivity threshold exceeded (Win32 input idle > 300s) or late-night circadian hours.',
  ...
  },
  {
    ...
    category: 'Achievement Pulse',
    triggerCondition: 'Build completion signals, successful git commits, or explicit double-click interaction.',
